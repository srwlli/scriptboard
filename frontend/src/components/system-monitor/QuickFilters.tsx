...
import { Globe, Code, Settings, Layout, Film, MessageSquare, Shield, Layers, Cpu, Clock } from "lucide-react";
...
const FILTERS: Array<{
  ...
  { id: "recent", label: "Recent", icon: <Clock size={12} />, color: "text-green-500" },
];
